...
import { faFileLines, faPaste, faHeartCirclePlus } from '@fortawesome/free-solid-svg-icons';
    ...
    <>
      <div className="w-[310px] h-screen bg-[#f8f8f8] shadow-lg p-6">
        <div className="mt-[50px]">
          ...
          <button className="mt-4 w-full h-[50px] bg-[#347fff] text-white py-2 rounded font-medium">다운로드로 결제</button>
        </div>
