...
const BookMarkAdd = ({ closeAddModal, bookmarksArray }: TPropsAddModal) => {
    ...
    <>
      <div className='w-[311px] h-[220px] bg-white rounded-[15px] fixed right-[24%] top-[58%]'>
        ...
        <div className='w-[122px] h-[34px] grid gap-[6px] grid-cols-2 pt-[34px] ml-[93px]'>
          ...
          <button className='w-[58px] h-[34px] border border-[#747474] rounded-[6px] text-[14px] bg-[#747474] text-white'>
            수정
          </button>
        </div>
